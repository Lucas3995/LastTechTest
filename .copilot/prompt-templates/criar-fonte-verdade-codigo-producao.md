...
4. **Regras para a etapa de implementação de código de produção:**
   ...
   - Na implementação, usar a skill **mercenário** (ler `.cursor/skills/mercenario/SKILL.md`): tradução de regras de negócio em código, sem alterar testes e sem análise de arquitetura/performance/qualidade.
