...
/// <summary>RA-4: In-memory implementation of IAnticipationSimulationCache for integration tests. One entry per creator (replaced on new Store). TTL and IsUsed supported.</summary>
public sealed class InMemoryAnticipationSimulationCache : IAnticipationSimulationCache
{
