...
# Poupar créditos com skills e scripts

Sempre que você for executar **uma ação ou um conjunto de ações** que consumam créditos e possam ser **transformadas em script** (nova skill ou alteração de skill existente), faça-o. O resultado final deve ser **o mesmo**; apenas a execução é delegada ao script para poupar créditos.
